      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <h2 className="text-2xl font-bold mb-6">
              ...
              <span className="text-white">{t('siteTitle.digital')}</span>
              <span className="text-white"> </span>
              <HubHighlight />
            </h2>
        ...
        <div className="flex flex-col md:flex-row justify-between">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} <span className="text-orange">{t('siteTitle.agency')}</span><span className="text-white"> </span><span className="text-white">{t('siteTitle.digital')}</span><span className="text-white"> </span><HubHighlight />. {t('footer.rights')}
          </p>
