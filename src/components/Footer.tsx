      ...
      <div className="container-custom">
        ...
        <div className="flex flex-col md:flex-row justify-between">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} <span><span className="text-orange">{t('siteTitle.agency')}</span><span style={{ color: '#FFFFFF' }}>{t('siteTitle.digital')}</span></span><HubHighlight className="text-sm" />. {t('footer.rights')}
          </p>
